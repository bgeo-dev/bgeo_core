...
export CONTAINER_NAME=ci_native_nowallet_libbgeokernel
...
export GOAL="install"
export BGEO_CONFIG="--enable-reduce-exports --enable-experimental-util-chainstate --with-experimental-kernel-lib --enable-shared"
