...
def main():
    ...
    bctester(os.path.join(env_conf["SRCDIR"], "test", "util", "data"), "bgeo-util-test.json", env_conf)
...
def bctest(testDir, testObj, buildenv):
    ...
    if testObj["exec"] == "./bgeo-util":
        execprog = os.getenv("BGEOUTIL", default=execprog)
    elif testObj["exec"] == "./bgeo-tx":
        execprog = os.getenv("BGEOTX", default=execprog)
    ...
    if "error_txt" in testObj:
        ...
        # That stderr is empty if no errors are expected. However, bgeo-tx
