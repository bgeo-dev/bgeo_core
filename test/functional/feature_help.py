...
"""Verify that starting bgeo with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start bgeo with -h for help text")
        ...
        self.log.info("Start bgeo with -version for version information")
        ...
        self.log.info("Start bgeod with -fakearg to make sure it does not start")
