...
class TestBitcoinCli(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getblockchaininfo RPC and `bgeo-cli getblockchaininfo`")
        ...
        # Prevent bgeo-cli from using existing rpcport in conf
        ...
        self.log.info("Test -getinfo and bgeo-cli return all proxies")
        ...
        if self.is_specified_wallet_compiled():
            self.log.info("Test -getinfo and bgeo-cli getwalletinfo return expected wallet info")
            ...
            # Test bgeo-cli -generate with -rpcwallet in multiwallet mode.
