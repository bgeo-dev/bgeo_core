...
#ifndef BGEOC_CAPNP_COMMON_TYPES_H
#define BGEOC_CAPNP_COMMON_TYPES_H
...
//! Functions to serialize / deserialize common bgeo types.
namespace mp {
...
#endif // BGEOC_CAPNP_COMMON_TYPES_H
