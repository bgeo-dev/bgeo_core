...
#ifndef BGEO_COMMON_ARGS_H
#define BGEO_COMMON_ARGS_H
...
extern const char * const BGEO_CONF_FILENAME;
extern const char * const BGEO_SETTINGS_FILENAME;
