...
#ifndef BGEO_COMMON_SIGNMESSAGE_H
#define BGEO_COMMON_SIGNMESSAGE_H
 ...
 * @param[in] address Signer's bgeo address, it must refer to a public key.
...
#endif // BGEO_COMMON_SIGNMESSAGE_H
