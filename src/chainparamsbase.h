...
#ifndef BGEO_CHAINPARAMSBASE_H
#define BGEO_CHAINPARAMSBASE_H
...
/**
 * CBaseChainParams defines the base parameters (shared between bgeo-cli and bgeod)
