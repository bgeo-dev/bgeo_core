// Copyright (c) 2009-2022 The Bgeo Core developers
 ...
 *  Bgeo because since the activation of BIP66, signatures are verified to be
...
bool CPubKey::Verify(const uint256 &hash, const std::vector<unsigned char>& vchSig) const {
     ...
     * not historically been enforced in Bgeo, so normalize them first. */
