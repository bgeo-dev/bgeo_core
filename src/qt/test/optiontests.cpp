...
{
    // Test regression https://github.com/bgeo/bgeo/issues/24457. Ensure
...
{
    // Test that the bug https://github.com/bgeo-core/gui/issues/567 does not resurface.
    // It was fixed via https://github.com/bgeo-core/gui/pull/568.
    // With fListen=false in ~/.config/Bgeo/Bgeo-Qt.conf and all else left as default,
    // bgeo-qt should set both -listen and -listenonion to false and start successfully.
