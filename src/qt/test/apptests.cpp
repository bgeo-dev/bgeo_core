...
//! Entry point for BgeoApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &BgeoApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for BgeoGUI tests.
void AppTests::guiTests(BgeoGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &BgeoGUI::consoleShown, this, &AppTests::consoleTests);
