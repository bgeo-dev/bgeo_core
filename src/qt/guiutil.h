...
#ifndef BGEO_QT_GUIUTIL_H
#define BGEO_QT_GUIUTIL_H
...
/** Utility functions used by the Bgeo Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "bgeo:" URI into recipient object, return true on successful parsing
