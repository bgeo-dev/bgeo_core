...
#ifndef BGEO_QT_OPTIONSMODEL_H
#define BGEO_QT_OPTIONSMODEL_H
...
/** Interface from Qt to configuration data structure for Bgeo client.
...
public:
    ...
    BgeoUnit getDisplayUnit() const { return m_display_bgeo_unit; }
...
Q_SIGNALS:
    void displayUnitChanged(BgeoUnit unit);
