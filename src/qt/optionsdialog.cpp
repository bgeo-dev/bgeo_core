      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->bgeoAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->bgeoAtStartup);
    ...
    ui->bgeoAtStartup->setToolTip(ui->bgeoAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->bgeoAtStartup->setText(ui->bgeoAtStartup->text().arg(PACKAGE_NAME));

    ui->openBgeoConfButton->setToolTip(ui->openBgeoConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new BgeoUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->bgeoAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openBgeoConfButton_clicked()
{
