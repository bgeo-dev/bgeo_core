...
#ifndef BGEO_QT_BGEOGUI_H
#define BGEO_QT_BGEOGUI_H
...
/**
  Bgeo GUI main class. This class represents the main window of the Bgeo UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class BgeoGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit BgeoGUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = nullptr);
    ~BgeoGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a bgeo wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
public Q_SLOTS:
    ...
    void incomingTransaction(const QString& date, BgeoUnit unit, const CAmount& amount, const QString& type, const QString& address, const QString& label, const QString& walletName);
#endif // ENABLE_WALLET
...
public Q_SLOTS:
    ...
    /** Load Partially Signed Bgeo Transaction from file or clipboard */
...
private Q_SLOTS:
    ...
    void updateDisplayUnit(BgeoUnit newUnits);
    /** Tells underlying optionsModel to update its current display unit. */
    void onMenuSelection(QAction* action);
};

#endif // BGEO_QT_BGEOGUI_H
