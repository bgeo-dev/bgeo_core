...
#ifndef BGEO_RPC_UTIL_H
#define BGEO_RPC_UTIL_H
...
/**
 * Parse a json number or string, denoting BGEO/kvB, into a CFeeRate (sat/kvB).
 * Reject negative values or rates larger than 1BGEO/kvB.
 */
