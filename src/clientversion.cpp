 ...
 * for both bgeod and bgeo-qt, to make it harder for attackers to
...
/**
 * Format the subversion field according to BIP 14 spec (https://github.com/bgeo/bips/blob/master/bip-0014.mediawiki)
 */
...
std::string CopyrightHolders(const std::string& strPrefix)
{
    ...
    if (copyright_devs.find("Bgeo Core") == std::string::npos) {
        strCopyrightHolders += "\n" + strPrefix + "The Bgeo Core developers";
    }
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/bgeo/bgeo>";
