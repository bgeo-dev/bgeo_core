...
{
    BOOST_CHECK(TestSplitHost("www.bgeocore.org", "www.bgeocore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.bgeocore.org]", "www.bgeocore.org", 0));
    BOOST_CHECK(TestSplitHost("www.bgeocore.org:80", "www.bgeocore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.bgeocore.org]:80", "www.bgeocore.org", 80));
    ...
    BOOST_CHECK(TestSplitHost("www.bgeocore.org:65536", "www.bgeocore.org:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.bgeocore.org:0", "www.bgeocore.org", 0, false));
    BOOST_CHECK(TestSplitHost("www.bgeocore.org:", "www.bgeocore.org:", 0, false));
}
