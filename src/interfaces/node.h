...
#ifndef BGEOTERFACES_NODE_H
#define BGEOTERFACES_NODE_H
...
//! Top-level interface for a bgeo node (bgeod process).
class Node
{
public:
    ...
    //! Return setting value from <datadir>/settings.json or bgeo.conf.
