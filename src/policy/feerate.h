...
#ifndef BGEO_POLICY_FEERATE_H
#define BGEO_POLICY_FEERATE_H
...
const std::string CURRENCY_UNIT = "BGEO"; // One formatted unit
...
enum class FeeEstimateMode {
    ...
    BGEO_KVB,      //!< Use BGEO/kvB fee rate unit
...
public:
    ...
    std::string ToString(const FeeEstimateMode& fee_estimate_mode = FeeEstimateMode::BGEO_KVB) const;
