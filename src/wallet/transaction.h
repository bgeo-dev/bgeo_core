...
#ifndef BGEO_WALLET_TRANSACTION_H
#define BGEO_WALLET_TRANSACTION_H
...
public:
     ...
     * on this bgeo node, and set to 0 for transactions that were created
...
#endif // BGEO_WALLET_TRANSACTION_H
