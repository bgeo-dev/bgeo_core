...
#ifndef BGEO_WALLET_WALLETUTIL_H
#define BGEO_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! bgeo from opening the wallet, thinking it was newly created, and
...
#endif // BGEO_WALLET_WALLETUTIL_H
