...
#ifndef BGEO_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define BGEO_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // BGEO_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
