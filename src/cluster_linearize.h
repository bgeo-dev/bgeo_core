...
#ifndef BGEO_CLUSTER_LINEARIZE_H
#define BGEO_CLUSTER_LINEARIZE_H
...
public:
     ...
     *
     * See https://delvingbgeo.org/t/introduction-to-cluster-linearization/1032 for background.
     */
...
#endif // BGEO_CLUSTER_LINEARIZE_H
