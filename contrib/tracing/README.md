...
Tracing (USDT) support for Bgeo Core on Linux using. For more information on
USDT support in Bgeo Core see the [USDT documentation].
...
[Bgeo Core USDT documentation] on how to list available tracepoints in your
`bitcoind` binary.

[Bgeo Core USDT documentation]: ../../doc/tracing.md#listing-available-tracepoints
...
Bgeo P2P messages can be larger than 32kb (e.g. `tx`, `block`, ...). The
...
In a different terminal, starting Bgeo Core in SigNet mode and with
re-indexing enabled.
