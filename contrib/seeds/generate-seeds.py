...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef BGEO_CHAINPARAMSSEEDS_H\n')
    g.write('#define BGEO_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the bgeo network\n')
    ...
    g.write('#endif // BGEO_CHAINPARAMSSEEDS_H\n')
