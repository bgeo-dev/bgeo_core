...
signature file SHA256SUMS.asc from bgeocore.org and bgeo.org and
compares them.
...
The builder keys are available in the guix.sigs repo:
    ...
    https://github.com/bgeo-core/guix.sigs/tree/main/builder-keys
...
HOST1 = "https://bgeocore.org"
HOST2 = "https://bgeo.org"
VERSIONPREFIX = "bgeo-core-"
...
def verify_published_handler(args: argparse.Namespace) -> ReturnCode:
    WORKINGDIR = Path(tempfile.gettempdir()) / f"bgeo_verify_binaries.{args.version}"
    ...
    # remove binaries that are known not to be hosted by bgeocore.org
...
def main():
    ...
    pub_parser.add_argument(
        'version', type=str, help=(
            f'version of the bgeo release to download; of the format '
    ...
    pub_parser.add_argument(
        ...
        help=(
            ...
            '(Sometimes bgeo.org lags behind bgeocore.org.)')
    )
