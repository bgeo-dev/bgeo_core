# Bootstrappable Bgeo Core Builds

This directory contains the files necessary to perform bootstrappable Bgeo
Core builds.
...
To build Bgeo Core reproducibly with all default options, invoke the
