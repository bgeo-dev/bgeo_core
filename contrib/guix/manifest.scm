...
(define* (make-bgeo-cross-toolchain target
                                       #:key
...
desirable for building Bgeo Core release binaries."
...
;; failure; see https://github.com/bgeo/bgeo/pull/27296.
    ...
    (cond ((string-suffix? "-mingw32" target)
          ...
          ((string-contains target "-linux-")
           (list bison
                 ...
                 (make-bgeo-cross-toolchain target)))
