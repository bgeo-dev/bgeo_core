...
# Extract options
function __fish_bgeo_tx_get_options
...
# Extract commands
function __fish_bgeo_tx_get_commands
...
complete \
    --command bgeo-tx \
    --condition "not __fish_bgeo_seen_cmd (__fish_bgeo_tx_get_commands --commandsonly)" \
    --arguments "(__fish_bgeo_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command bgeo-tx \
    --arguments "(__fish_bgeo_tx_get_commands)" \
    --no-files
