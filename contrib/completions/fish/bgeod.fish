...
complete --command bgeod --no-files

# Extract options
function __fish_bgeod_get_options
...
complete \
    --command bgeod \
    --arguments "(__fish_bgeod_get_options --nofiles)"
