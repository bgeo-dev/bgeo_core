...
- #7209 `f3ad812` test: don't override BGEOD and BGEOCLI if they're set (Wladimir J. van der Laan)
...
- #6401 `6db53b4` Add BGEOD_SIGTERM_TIMEOUT to OpenRC init scripts (Florian Schmaus)
